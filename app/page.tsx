        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            {[{ icon: Shield, title: "Asset Management", desc: "Comprehensive tracking with verification and secure protocols" },
              ...
              { icon: Eye, title: "Audit Logging", desc: "Complete activity tracking for transparency" }].map((feature, i) => (
              <Card 
                key={i}
                className="p-6 group transition-all duration-300 hover:shadow-2xl hover:shadow-primary/20 hover:-translate-y-1 border-border/50 hover:border-primary/30 glass-effect cursor-default animate-slide-in-up"
